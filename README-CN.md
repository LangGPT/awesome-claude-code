...
|[cchub](https://github.com/Moresl/cchub) | ![GitHub Repo stars](https://badgen.net/github/stars/Moresl/cchub) | Claude Code 全生态管理平台：MCP 市场、配置切换、技能、工作流、安全审计、自动驾驶 | Tauri v2 + React + Rust 桌面应用|
