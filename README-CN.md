...
|[ariadne-loop](https://github.com/zhangzeyu99-web/ariadne-loop) | ![GitHub Repo stars](https://badgen.net/github/stars/zhangzeyu99-web/ariadne-loop) | 为 Claude Code、Codex 和 OpenClaw 生成可验证的 Loop Engineering 规范、agent 执行包、验证门和 JSON 报告契约 | Loop 工程工作流|
