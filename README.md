...
|[align](https://github.com/ggrigo/align) | ![GitHub Repo stars](https://badgen.net/github/stars/ggrigo/align) | Personal evals trio for Claude Code and Cowork — /align rates LLM claims, /diagnose traces wrong claims back to stale instructions, /retro synthesizes patterns and opens patch PRs | Human-in-the-loop personal evals plugin|
