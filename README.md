...
|[usage](https://github.com/aqua5230/usage) | ![GitHub Repo stars](https://badgen.net/github/stars/aqua5230/usage) | macOS menu bar app that pins Claude Code and Codex quota, tokens, and cost. Local-only — reads a statusLine hook (Claude Code) and JSONL session logs (Codex); no API calls. HTML reports and TUI mode included. | macOS menu bar monitor|
