...
|[ORCH](https://github.com/oxgeneral/ORCH) | ![GitHub Repo stars](https://badgen.net/github/stars/oxgeneral/ORCH) | CLI orchestrator that coordinates Claude Code, Codex, Cursor, and shell scripts as a typed AI team with validated state machine (todo→in_progress→review→done), auto-retry, TUI dashboard, and inter-agent messaging. 1647 tests. MIT. | Multi-agent orchestrator|
