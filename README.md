...
|[harmony-next.skills](https://github.com/linhay/harmony-next.skills) | ![GitHub Repo stars](https://badgen.net/github/stars/linhay/harmony-next.skills) | HarmonyOS NEXT developer skill with local ArkTS/ArkUI/API references, DevEco Studio workflows, Emulator/HDC automation, UI/UX audit, trace audit, and smoke-test templates | HarmonyOS NEXT skill|
