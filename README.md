...
|[cchub](https://github.com/Moresl/cchub) | ![GitHub Repo stars](https://badgen.net/github/stars/Moresl/cchub) | Claude Code ecosystem management platform: MCP marketplace, config profiles, skills, workflows, security audit, autopilot | Tauri v2 + React + Rust desktop app|
