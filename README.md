...
|[claude-code-shared-memory](https://github.com/Mrshahidali420/claude-code-shared-memory) | ![GitHub Repo stars](https://badgen.net/github/stars/Mrshahidali420/claude-code-shared-memory) | Persistent memory shared across all projects using the official remember plugin, a global MEMORY.md index and the MCP memory server; no external app or database | Cross-project memory|
