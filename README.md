...
|[agenthatch](https://github.com/agenthatch/agenthatch) | ![GitHub Repo stars](https://badgen.net/github/stars/agenthatch/agenthatch) | Compile agent skills into standalone AI agents — turns Skill into Agent with validated tool execution and PlanLayer state machine | Skill-to-Agent compiler|
