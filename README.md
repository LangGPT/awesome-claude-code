...
|[Thoth](https://github.com/SeeleAI/Thoth) | ![GitHub Repo stars](https://badgen.net/github/stars/SeeleAI/Thoth) | Dashboard-first Claude Code and Codex runtime for durable agent runs, work-item locks, ledgers, and reviewable verdicts | Dual Claude Code/Codex runtime|
