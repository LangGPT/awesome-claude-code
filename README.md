...
|[reporecall](https://github.com/proofofwork-agency/reporecall) | ![GitHub Repo stars](https://badgen.net/github/stars/proofofwork-agency/reporecall) | Local codebase memory — AST indexing (22 langs), call graphs, hybrid search. Injects context via hooks (~5ms) or MCP | Codebase memory|
