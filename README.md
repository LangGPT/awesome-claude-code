...
|[nimbalyst](https://github.com/nimbalyst/nimbalyst) | ![GitHub Repo stars](https://badgen.net/github/stars/nimbalyst/nimbalyst) | Open-source visual workspace to run Claude Code, Codex, and other agents, with visual editors with reviewable diffs, tasks, and git worktrees | Visual multi-agent workspace|
