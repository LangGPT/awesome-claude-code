...
|[awesome-claude-code-hooks](https://github.com/loqimean/awesome-claude-code-hooks) | ![GitHub Repo stars](https://badgen.net/github/stars/loqimean/awesome-claude-code-hooks) | Curated list of Claude Code hooks and examples | Hooks collection|
