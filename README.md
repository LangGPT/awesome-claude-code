...
|[cortex-memory](https://github.com/SKULLFIRE07/cortex-memory) | ![GitHub Repo stars](https://badgen.net/github/stars/SKULLFIRE07/cortex-memory) | Persistent AI memory for coding assistants with 3-layer memory (working/episodic/semantic). VSCode extension + CLI + MCP server | AI memory system|
