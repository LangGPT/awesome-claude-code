...
|[Usage HUD](https://github.com/Thalia-Bloom/usage-hud) | ![GitHub Repo stars](https://badgen.net/github/stars/Thalia-Bloom/usage-hud) | Native Mac menu-bar meter for Claude, Codex, Gemini, Grok, and Ollama usage windows, with a confidence label on every number. Paid, local-only | Mac usage meter|
