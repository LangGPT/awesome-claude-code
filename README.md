...
|[ORCH](https://github.com/oxgeneral/ORCH) | ![GitHub Repo stars](https://badgen.net/github/stars/oxgeneral/ORCH) | CLI runtime for orchestrating AI agent teams. Coordinates Claude Code, OpenCode (Codex/Gemini), Cursor as typed task queue with state machine, auto-retry, inter-agent messaging, TUI dashboard. 1647 tests, MIT, TypeScript | Multi-agent orchestration runtime|
