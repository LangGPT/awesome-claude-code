...
|[agenttrace](https://github.com/luoyuctl/agenttrace) | ![GitHub Repo stars](https://badgen.net/github/stars/luoyuctl/agenttrace) | Local-first TUI observability for Claude Code, Codex, and Cursor session traces | Session observability|
