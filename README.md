...
|[ai-agent-safety-starter-pack](https://github.com/el-zachariah/ai-agent-safety-starter-pack) | ![GitHub Repo stars](https://badgen.net/github/stars/el-zachariah/ai-agent-safety-starter-pack) | Free lite repo preflight scanner for Claude Code, Cursor, Codex-style agents, MCP configs, risky scripts, and secret-adjacent files | Agent safety preflight|
