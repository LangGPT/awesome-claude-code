...
|[Hephaestus](https://github.com/agentlas-ai/Hephaestus) | ![GitHub Repo stars](https://badgen.net/github/stars/agentlas-ai/Hephaestus) | Open Agent OS for Claude Code, Codex, and Cursor with local-first routing, skills, memory, and MCP Hub fallback | Agent OS / orchestration runtime|
