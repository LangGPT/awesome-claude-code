...
|[agent-manager-skill](https://github.com/fractalmind-ai/agent-manager-skill) | ![GitHub Repo stars](https://badgen.net/github/stars/fractalmind-ai/agent-manager-skill) | tmux + Python agent lifecycle manager (start/stop/monitor/assign) for local terminal agents | Multi-agent orchestration|
