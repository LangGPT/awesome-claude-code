...
|[llm-wiki-cli](https://github.com/JanYork/llm-wiki-cli) | ![GitHub Repo stars](https://badgen.net/github/stars/JanYork/llm-wiki-cli) | Proactive project memory CLI with source citations, full-text retrieval, optional document/code graphs, and a bounded read-only MCP server | Project memory MCP|
