...
|[cc-safe-setup](https://github.com/yurukusa/cc-safe-setup) | ![GitHub Repo stars](https://badgen.net/github/stars/yurukusa/cc-safe-setup) | One-command safety hooks: 8 built-in + 32 examples, audit, create, lint, watch | Safety hooks CLI|
|[cc-hook-test](https://github.com/yurukusa/cc-hook-test) | ![GitHub Repo stars](https://badgen.net/github/stars/yurukusa/cc-hook-test) | Test runner for Claude Code hooks with auto-detection and test generation | Hook testing tool|
