...
|[tokenhabit](https://github.com/epoko77-ai/tokenhabit) | ![GitHub Repo stars](https://badgen.net/github/stars/epoko77-ai/tokenhabit) | Scans Claude Code logs for token-wasting habits, each with a copy-paste fix + an A–F Waste Score; diagnosis complement to ccusage (no LLM calls, offline) | Usage analysis|
