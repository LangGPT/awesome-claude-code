...
|[x-twitter-scraper](https://github.com/Xquik-dev/x-twitter-scraper) | ![GitHub Repo stars](https://badgen.net/github/stars/Xquik-dev/x-twitter-scraper) | X/Twitter data extraction skill with MCP server, REST API, 20 bulk tools | X/Twitter data platform|
